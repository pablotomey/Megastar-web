...
<body>
  ...
  <section id="header-accesorios">
    <div class="wrapper">
        <h1 class="title">Accesorios para todo</h1>
    </div>
  </section>
  ...
  <section id="offers">
    <div class="wrapper">
      <h1>Todos los accesorios para ti</h1>
      <div class="offers-cards">
      <?php
        require 'db.php';
        $accesorios = "accesorios";
        $sql2 = "SELECT * FROM producto WHERE category='".$accesorios."' ";
