...
<body>
  ...
  <section id="header-ropa-mujer">
    <div class="wrapper">
        <h1 class="title">Moda mujer</h1>
    </div>
  </section>
  ...
  <section id="offers">
    <div class="wrapper">
      <h1>Encuentra la colección ideal para ti</h1>
      <div class="offers-cards">
      <?php
        require 'db.php';
        $ropaMujer = "ropa-mujer";
        $sql2 = "SELECT * FROM producto WHERE category='".$ropaMujer."' ";
