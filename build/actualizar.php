  ...
  <div class="wrapper">
    ...
    <form action="actualizar_producto.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="name" value="<?php echo $fila['name'] ?>" required>
      </div>
      <div class="form-group">
        <label for="description">Descripción del producto</label>
        <input type="text" class="form-control" name="description" id="description" value="<?php echo $fila['description'] ?>" required>
      </div>
