...
<body>
  ...
  <section id="header-jugueteria">
    <div class="wrapper">
        <h1 class="title">Gran variedad en Juguetería</h1>
    </div>
  </section>
  ...
  <section id="offers">
    <div class="wrapper">
      <h1>Eligue el mejor regalo para los mas pequeños</h1>
      <div class="offers-cards">
      <?php
        require 'db.php';
        $juguetes = "juguetes";
        $sql2 = "SELECT * FROM producto WHERE category='".$juguetes."' ";
